    ...
    return Scaffold(
      ...
      body: SafeArea(child: ListView(
        ...
        children: <Widget>[
          ...
          const SizedBox(height: 12),
          const _FoundationCard(description: 'Một tài khoản có thể tham gia nhiều cửa hàng.', icon: Icons.storefront_outlined, title: 'Multi-tenant'),
          const SizedBox(height: 12),
          const _FoundationCard(description: 'Realtime báo thay đổi, delta sync bảo đảm đầy đủ.', icon: Icons.sync_outlined, title: 'Revision sync')
        ],
      )),
    );
  }
...
class _FoundationCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      elevation: 0,
      child: Padding(padding: const EdgeInsets.all(18), child: Row(
